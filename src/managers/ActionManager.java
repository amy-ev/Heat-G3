...
public class ActionManager {
  ...
  private ExitProgramAction exitProgramAction = new ExitProgramAction("Quit",
      Resources.getIcon("exit32"), "Quit HEAT", new Integer(KeyEvent.VK_Q),
  ...
  private PrintFileAction printFileAction = new PrintFileAction("Print",
		  Resources.getIcon("fileprint32"), "Print editor content or interpreter console",
  ...
  private ShowOptionsAction showOptionsAction = new ShowOptionsAction("Options",
	      Resources.getIcon("list32"), "Change HEAT Options",
  ...
  // editing actions
  private UndoAction undoAction = new UndoAction("Undo", Resources.getIcon("undo32"),
  ...
  private UndoAction toolbarUndoAction = new UndoAction(null, Resources.getIcon("undo32"),
	      "Undo last change", new Integer(KeyEvent.VK_Z),
	      KeyStroke.getKeyStroke(KeyEvent.VK_Z, java.awt.Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));
  private RedoAction redoAction = new RedoAction("Redo", Resources.getIcon("redo32"),
  ...
  private ShowHelpAction showHelpAction = new ShowHelpAction("Help",
      Resources.getIcon("help32"), "Display help", new Integer(KeyEvent.VK_L),
  ...
  private ShowAboutAction showAboutAction = new ShowAboutAction("About",
      Resources.getIcon("info32"), "Display about information", null, null);
  

  private RefreshTreeAction refreshTreeAction = new RefreshTreeAction("", Resources.getIcon("load32"),
           "Refresh overview");
  private ExpandTreeAction expandTreeAction = new ExpandTreeAction("", Resources.getIcon("expandTreeWindow32"),
           "Expand all overview elements");
  private CollapseTreeAction collapseTreeAction = new CollapseTreeAction("", Resources.getIcon("collapseTreeWindow32"),
